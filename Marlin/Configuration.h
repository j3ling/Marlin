...
#define STRING_CONFIG_H_AUTHOR "(drj, MTW MiniMax config)" // Who made the changes.
...
#define TEMP_RESIDENCY_TIME 6  // (seconds) - drj: default 10
#define TEMP_HYSTERESIS 3       // (degC) range of +/- temperatures considered "close" to the target one
#define TEMP_WINDOW     1       // (degC) Window around target to start the residency timer x degC early.

// Bed temperature must be close to target for this long before M190 returns success
#define TEMP_BED_RESIDENCY_TIME 6  // (seconds) - drj: default 10
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 10000 }      // MTW ABL config
//#define DEFAULT_MAX_ACCELERATION { 1100, 1100, 80, 10000 }      // MTW no ABL config
...
// default old marlin and MTW ABL
...
#define XY_PROBE_SPEED 7000 // drj: default 8000
