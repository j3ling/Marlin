...
#define STRING_CONFIG_H_AUTHOR "(drj, MTW MM3 dual BLTouch config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MM3"
...
#define HOTEND_OFFSET_X {0.0, -32.60} // (in mm) for each extruder, offset of the hotend on the X axis
