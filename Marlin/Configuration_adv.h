...
#define DEFAULT_STEPPER_DEACTIVE_TIME 60  // drj default 120
...
#define DIGIPOT_MOTOR_CURRENT { 135,135,185,135,135 }   // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
